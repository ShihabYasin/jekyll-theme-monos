...
- **[Commchat Messaging & Calling App (Android)](https://web.archive.org/web/20211004182141/https://play.google.com/store/apps/details?id=com.ccp.comm)**
  ...
  Worked on Multilingual speech to text, phonetic typing, text to speech etc. This is a messaging and calling app that delivers the utmost privacy and security.
